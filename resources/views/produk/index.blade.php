            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-action">
                        <a href="{{ route('produks.create') }}" class="btn btn-primary" style="border-radius: 5px"><i
                                class="fa fa-plus"></i> Tambah Data</a>
                        <a href="{{ route('transaksi.index') }}" class="btn btn-success" style="border-radius: 5px">Transaksi <i
